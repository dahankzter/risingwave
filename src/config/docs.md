...
| sstable_filter_layout | Per-level xor filter layout for compaction output. "auto" uses the kv-count heuristic; "plain" forces non-blocked filters and ignores kv-count threshold. Index by LSM level: `0..=max_level`. Note: L0 (index 0) is currently ignored by shared-buffer flush, which always uses "auto". | ["auto", "auto", "auto", "auto", "auto", "auto", "auto"] |
| sstable_filter_type | Per-level xor filter family for compaction output. Index by LSM level: `0..=max_level`. Note: L0 (index 0) is currently ignored by shared-buffer flush, which always uses "xor16". | ["xor16", "xor16", "xor16", "xor16", "xor16", "xor16", "xor16"] |
